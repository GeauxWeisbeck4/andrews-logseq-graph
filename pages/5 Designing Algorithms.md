...
- # 5 Designing Algorithms
	...
	- ## Greedy Algorithms
		...
		- ### Minimum Spanning Tree
			...
			- We will use a minimum spanning tree, and Kruskal's algorithm which is a greedy algorithm that solves it and is guaranteed to find the optimal solution. Start by choosing teh cheapest segment of road until all houses are connected, and always add the cheapest possible segment that won't generate a loop. It will be explored in later chapters